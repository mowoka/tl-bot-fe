...
export function LaporLangsungHistory(props: LaporLangsungHistory) {
  ...
  return (
    <div className="bg-secondary w-full max-w-[1200px] min-h-[400px] border-none outline-none rounded-lg p-6">
      <p className="text-xl uppercase font-semibold">Lapor Langsung</p>
      <div className="py-6">
              ...
              {!isLoading &&
                datas?.map((data, index) => (
                  ...
                  >
                    ...
                    <TableCell align="left">{data.customer_phone}</TableCell>
