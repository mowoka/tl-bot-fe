...
import { TicketGaulSqm } from "@app/hooks/home/getTeknisiHistoryFetcher";

interface GaulSQMProps extends TableHistory {
  datas: TicketGaulSqm[];
  metadata: MetaData;
}

export function GaulSQMHistory(props: GaulSQMProps) {
  ...
  return (
    <div className="bg-secondary w-full max-w-[1200px] min-h-[400px] border-none outline-none rounded-lg p-6">
      <p className="text-xl uppercase font-semibold">Tiket Gaul SQM</p>
      <div className="py-6">
